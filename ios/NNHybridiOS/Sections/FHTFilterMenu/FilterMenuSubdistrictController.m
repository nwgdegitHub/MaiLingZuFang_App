...
- (void)viewDidLoad {
    ...
    [self loadData:[[CityManager sharedInstance].selectedCityId integerValue]];
...
- (void)loadData:(NSInteger)cityId
{
  ...
  NSArray *rawDistricts = [[CityManager sharedInstance] getCityRegionListWithCityId:[NSString stringWithFormat:@"%ld",(long)cityId]];
  //[MYUtil getCityRegion:cityId];
    if (rawDistricts != nil) {
